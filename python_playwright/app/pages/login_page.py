...
class LoginPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.forgot_password_link = self.page.locator("button", has_text="Forgot your password?")
        self.sign_up_link = self.page.locator("button", has_text="Sign up")
        self.login_with_microsoft_button = self.page.locator("button").filter(has_text="Login with Microsoft")
